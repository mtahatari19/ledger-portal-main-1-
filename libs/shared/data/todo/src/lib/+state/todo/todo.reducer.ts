...
export const todoAdapter: EntityAdapter<TodoEntity> = createEntityAdapter<TodoEntity>();
...
const todoReducer = createReducer(
  ...
  on(TodoActions.loadTodoSuccess, (state, { todo }) => todoAdapter.setAll(todo, { ...state, loaded: true })),
